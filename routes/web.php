...
Route::get('/cards/{id}/edit', [App\Http\Controllers\CardController::class, 'edit'])->name('cards_edit');
Route::put('/cards/{id}', [App\Http\Controllers\CardController::class, 'update'])->name('cards_update');
Route::delete('/cards/{id}', [App\Http\Controllers\CardController::class, 'destroy'])->name('cards_delete');
